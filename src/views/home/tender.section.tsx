...
const TenderSection = () => {
  return (
    <div className="w-full h-screen px-16 flex-col justify-center items-start gap-16 inline-flex">
      <div className="self-stretch py-16 justify-start items-center gap-24 inline-flex">
        <div className="w-[549px] flex-col justify-center items-start gap-8 inline-flex">
          <div className="self-stretch h-[232px] flex-col justify-center items-start gap-3 flex">
            <div className="self-stretch text-[#f2f2f2] text-7xl font-bold font-['Plus Jakarta Sans'] leading-[86.40px]">
              EXCLUSIVE OFFER
            </div>
          ...
          <div className="w-[315px] h-[65px] bg-[#ff1818] rounded-full blur-[196.80px]" />
